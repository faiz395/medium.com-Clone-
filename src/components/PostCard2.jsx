...
function PostCard2({ $id, title, content, featuredImage, className , likesCount=0, commentsCount=10, publishdate="13th May" }) {
  ...
  return (
    <Link to={`/post/${$id}`} className={`block group my-6 ${className}`}>
      <div className="flex flex-col items-stretch p-4 border rounded-lg hover:shadow-lg transition-shadow duration-300 ease-in-out">
        ...
        <div className=" flex flex-wrap justify-center space-x-2 my-3">
            <div className="flex items-center space-x-[4px]">
              ...
              <span className="text-[13px] text-[#6b6b6b]">{publishdate}</span>
            </div>
            <div className="flex items-center space-x-[4px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center space-x-[4px]">
              ...
              <span className="text-[13px] text-[#6b6b6b]">{commentsCount}</span>
            </div>
          </div>
      </div>
    </Link>
