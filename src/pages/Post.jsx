...
import { Comments, Container, Loader, PostCard2, ProfileBadgeSmall,ProfileBadgeBig } from "../components/index.js";
  ...
  return post ? (
    <>
      ...
      >
        ...
        <ProfileBadgeSmall postAuthorId={post?.userId} followerId={userData?.$id}/>
        ...
        <ProfileBadgeBig postAuthorId={post?.userId} followerId={userData?.$id}/>
        ...
        <div className="flex flex-wrap justify-center m-3">
          {posts &&
            posts.map((post) => {
              ...
              const commentArray = commentsData.filter(comment => comment.postId === post.postId);
